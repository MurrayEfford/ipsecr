...
CHcpp <- function(animals, traps, Tsk, detectfn, detect, gsb, btype, Markov, binomN) {
    .Call('_ipsecr_CHcpp', PACKAGE = 'ipsecr', animals, traps, Tsk, detectfn, detect, gsb, btype, Markov, binomN)
}
