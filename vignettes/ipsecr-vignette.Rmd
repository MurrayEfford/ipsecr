...
There are limitations: **ipsecr** 1.2 does not allow variation in detection parameters (e.g., $\lambda_0$, $\sigma$) with respect to occasion, detector or previous detection (e.g., ~t, ~b or ~bk as allowed in **secr**) and NT may vary with session and detector (trap) but not occasion.
