...
```{r readnontarget, echo = FALSE, eval = FALSE}
# previously...
# setwd('../ipsecr/inst/example')
...
The new parameter 'lambdak' is the hazard for a disturbance process competing for detectors with the capture process:
